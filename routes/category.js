...
const controller = require('../controllers/category') // Este es el controlador que va a correr la acciones que se ejecuten en esta ruta (/categories)
...
module.exports = (router) => {
  ...
  router.route('/categories/:id') // Notar el :id || Sólo se va a actuar en una categoria en particular
    .put(controller.update) // Un PUT modifica los datos de una categoria
    .get(controller.getById) // Un GET obtiene los datos de una categoria
