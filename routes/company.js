...
const controller = require('../controllers/company') // Este es el controlador que va a correr la acciones que se ejecuten en esta ruta (/companies)
const validateToken = require('../utils').validateToken

module.exports = (router) => {
  router.route('/companies') // Si el usuario le pega a /companies (ej.: http://api/v1/companies)
  ...
  router.route('/companies/:id') // Notar el :id || Sólo se va a actuar en una empresa en particular
